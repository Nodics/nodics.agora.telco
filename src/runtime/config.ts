...
export const runtimeConfig: AgoraRuntimeConfig = Object.freeze({
  cmsBaseUrl:
    import.meta.env.VITE_STOREFRONT_CMS_BASE_URL ?? "http://localhost:4314",
  mediaBaseUrl:
    import.meta.env.VITE_STOREFRONT_MEDIA_BASE_URL ?? "http://localhost:4314",
  profileBaseUrl:
    import.meta.env.VITE_STOREFRONT_PROFILE_BASE_URL ?? "http://localhost:4300",
  commerceBaseUrl:
    import.meta.env.VITE_STOREFRONT_COMMERCE_BASE_URL ?? localStorefrontOrigin,
  engagementBaseUrl:
    import.meta.env.VITE_STOREFRONT_ENGAGEMENT_BASE_URL ??
    "http://localhost:4340",
  ...
  storeCode: import.meta.env.VITE_STOREFRONT_STORE_CODE ?? "agoraTelcoStore",
  domainCode: import.meta.env.VITE_STOREFRONT_DOMAIN_CODE ?? "telco",
  currency: import.meta.env.VITE_STOREFRONT_CURRENCY ?? "AED",
  locale: import.meta.env.VITE_STOREFRONT_LOCALE ?? "en",
  requestTimeoutMs: Number(
    import.meta.env.VITE_STOREFRONT_REQUEST_TIMEOUT_MS ?? 10000,
  ),
  customerAccessToken:
    import.meta.env.VITE_STOREFRONT_CUSTOMER_ACCESS_TOKEN || undefined,
